...
const Contact = () => {
  return (
    <div className="w-10/12 mx-auto my-52 md:my-32">
      <h2 className="text-4xl text-center font-semibold mb-14">Contact with us</h2>
      <div className="grid gap-5 grid-cols-1 lg:grid-cols-2">
        <div className="p-5 lg:p-10 bg-fuchsia-50 rounded-2xl">
          ...
          ></textarea>
          <button className="bg-purple-300 py-2 px-6 rounded-full mb-2 font-bold uppercase">Submit</button>
        </div>
